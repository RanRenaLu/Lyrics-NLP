...
![](/Users/ran_lu/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/figs/wordcloud-lyrics.jpg)  
...
```
![](/Users/ran_lu/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/figs/rock.png)
\newline
\newline
...
```
![](/Users/ran_lu/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/figs/pop.png)
\newline
\newline
...
wordcloud_2000s <- count(filter(word_tibble, id %in% which(dt_lyrics$time == "2000s")), word, sort = TRUE) %>%
      ...
      wordcloud2(color="random-light", backgroundColor="dark", size=1, minRotation = pi/2, maxRotation = pi/2, rotateRatio = 0.5)
```
![](/Users/ran_lu/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/figs/2000s.png)
> 2000s  
...
```
![2010s](/Users/ran_lu/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/figs/2010s.png)
> 2010s  
...
# write.csv(nrc_sentiment,"../output/nrc_sentiment.csv")
nrc_sentiment <- read_csv("../output/nrc_sentiment.csv")
...
```
![](/Users/ran_lu/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/figs/time_plot.png)
...
genre_plot <- lyrics_sentiment %>% group_by(genre) %>% mutate(sentiment = positive - negative) %>% 
  ...
  theme(axis.text.x = element_blank(), axis.title = element_blank(), panel.grid = element_blank())
```
![](/Users/ran_lu/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/figs/genre_plot.png)
...
# write.csv(out, file = "~/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/output/sentiment_by_out.csv")
# out_time <- with(dt_lyrics, sentiment_by(stemmedwords, list(time)))
# write.csv(out_time, file = "~/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/output/sentiment_by_out_time.csv")
# out_genre <- with(dt_lyrics, sentiment_by(stemmedwords, list(genre)))
# write.csv(out_time, file = "~/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/output/sentiment_by_out_genre.csv")

out_time <- read_csv("../output/sentiment_by_out_time.csv")
out_genre <- read_csv("../output/sentiment_by_out_genre.csv")
out <- read_csv("../output/sentiment_by_out.csv")
# To properly run the plots, need to used the with sentiment_by output, reimporting the data will not work.
# plot(out)
# plot(out_genre)
# plot(out_time)
```
![sentiment score plot for decades](/Users/ran_lu/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/figs/out_time_plot.png)
...
![sentiment score plot for genres](/Users/ran_lu/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/figs/out_genre_plot.png)
...
![](/Users/ran_lu/Documents/Documents - Ran’s MacBook Pro/GitHub/Lyrics-NLP/figs/Lyrics.jpg)
